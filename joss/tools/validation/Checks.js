(function(window, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		define(['jquery', 'joss/dojo', 'dojo/number', 'dojo/date/locale'], factory);
	} else {
		// Browser globals
		dojo.setObject('joss.tools.validation.Checks', factory(jQuery, dojo));
	}
})(this, function($, dojo) {
	...
	return {
		...
		isNumber: function(value) {
			return !isNaN(dojo.number.parse(value));
		},
		...
		isDate: function(value) {
			...
			$.each(['date', 'datetime'], function(i, selector) {
				...
				$.each(['short', 'medium', 'long', 'full'], function(i, formatLength) {
					if (dojo.date.locale.parse(value, {formatLength: formatLength, selector: selector})) {
						success = true;
						return false; //break
					}
				});
