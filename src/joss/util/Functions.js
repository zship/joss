...
define(function(require) {
	...
	var Functions = {
		...
		/**
		 * Returns a function that will not be called as long as it continues
		 * to be invoked within the given ms delay.
		 * @param {Function} fn
		 * @param {Number} ms
		 * @return {Function}
		 */
		...
		/**
		 * Returns a function which will be invoked once every **ms**
		 * milliseconds
		 * @param {Function} fn
		 * @param {Number} ms
		 * @return {Function}
		...
		/**
		 * Returns a function which will execute in **ms**
		 * milliseconds, unless cancelled by Functions#cancel
		 * @param {Function} fn
		 * @param {Number} ms
		 * @return {Function}
		 */
